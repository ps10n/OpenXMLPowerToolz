...
Here is creating a new WmlDocument:
    ...
    private OpenXmlPowerToolzDocument CreateSplitDocument(WordprocessingDocument source, List<XElement> contents, string newFileName)
    {
        using (OpenXmlMemoryStreamDocument streamDoc = OpenXmlMemoryStreamDocument.CreateWordprocessingDocument())
        {
            ...
            OpenXmlPowerToolzDocument newDoc = streamDoc.GetModifiedDocument();
...
namespace OpenXmlPowerToolz
{
    ...
    public class OpenXmlPowerToolzDocument
    {
        public string FileName { get; set; }
        public byte[] DocumentByteArray { get; set; }

        public static OpenXmlPowerToolzDocument FromFileName(string fileName)
        {
            ...
            {
                OpenXmlPowerToolzDocument pkg = new OpenXmlPowerToolzDocument(bytes);
        ...
        public static OpenXmlPowerToolzDocument FromDocument(OpenXmlPowerToolzDocument doc)
        {
            ...
            return null;    // This should not be possible from a valid OpenXmlPowerToolzDocument object
        }

        public OpenXmlPowerToolzDocument(OpenXmlPowerToolzDocument original)
        {
        ...
        public OpenXmlPowerToolzDocument(OpenXmlPowerToolzDocument original, bool convertToTransitional)
        {
        ...
        public OpenXmlPowerToolzDocument(string fileName)
        {
            this.FileName = fileName;
            DocumentByteArray = File.ReadAllBytes(fileName);
        }

        public OpenXmlPowerToolzDocument(string fileName, bool convertToTransitional)
        {
            this.FileName = fileName;
        ...
        public OpenXmlPowerToolzDocument(byte[] byteArray)
        {
        ...
        public OpenXmlPowerToolzDocument(byte[] byteArray, bool convertToTransitional)
        {
            if (convertToTransitional)
            {
        ...
        public OpenXmlPowerToolzDocument(string fileName, MemoryStream memStream)
        {
            FileName = fileName;
        ...
        public OpenXmlPowerToolzDocument(string fileName, MemoryStream memStream, bool convertToTransitional)
        {
            if (convertToTransitional)
            {
    ...
    public partial class WmlDocument : OpenXmlPowerToolzDocument
    {
        public WmlDocument(OpenXmlPowerToolzDocument original)
            : base(original)
        {
        ...
        public WmlDocument(OpenXmlPowerToolzDocument original, bool convertToTransitional)
    ...
    public partial class SmlDocument : OpenXmlPowerToolzDocument
    {
        public SmlDocument(OpenXmlPowerToolzDocument original)
            : base(original)
        {
        ...
        public SmlDocument(OpenXmlPowerToolzDocument original, bool convertToTransitional)
            : base(original, convertToTransitional)
        {
            if (GetDocumentType() != typeof(SpreadsheetDocument))
                throw new PowerToolsDocumentException("Not a Spreadsheet document.");
    ...
    public partial class PmlDocument : OpenXmlPowerToolzDocument
    {
        public PmlDocument(OpenXmlPowerToolzDocument original)
            : base(original)
        {
        ...
        public PmlDocument(OpenXmlPowerToolzDocument original, bool convertToTransitional)
            : base(original, convertToTransitional)
        {
            if (GetDocumentType() != typeof(PresentationDocument))
                throw new PowerToolsDocumentException("Not a Presentation document.");
    ...
    {
        private OpenXmlPowerToolzDocument Document;
        private MemoryStream DocMemoryStream;
        private Package DocPackage;

        public OpenXmlMemoryStreamDocument(OpenXmlPowerToolzDocument doc)
        {
            Document = doc;
        ...
        public OpenXmlPowerToolzDocument GetModifiedDocument()
        {
            DocPackage.Close();
            DocPackage = null;
            return new OpenXmlPowerToolzDocument((Document == null) ? null : Document.FileName, DocMemoryStream);
        }
