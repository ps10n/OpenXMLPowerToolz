...
namespace OpenXmlPowerToolz
{
    ...
    public class ListItemRetriever
    {
        ...
        public static void SetParagraphLevel(XElement paragraph, int ilvl)
        {
            ...
            throw new OpenXmlPowerToolzException("Internal error - should never set ilvl more than once.");
        }
        ...
        public static int GetParagraphLevel(XElement paragraph)
        {
            ...
            if (pi != null)
                return pi.Ilvl;
            throw new OpenXmlPowerToolzException("Internal error - should never ask for ilvl without it first being set.");
        }
        ...
        public static ListItemInfo GetListItemInfo(XDocument numXDoc, XDocument stylesXDoc, XElement paragraph)
        {
            ...
            if (listItemInfo != null)
                return listItemInfo;
            throw new OpenXmlPowerToolzException("Attempting to retrieve ListItemInfo before initialization");
        }
