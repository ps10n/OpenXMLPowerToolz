...
using OpenXmlPowerToolz.HtmlToWml;
using System;
using System.IO;
using System.Linq;
...
AAAAAAAAAAAAAAAANi8AAGRvY1Byb3BzL2FwcC54bWxQSwUGAAAAAAwADAAJAwAA3DEAAAAA";
    ...
    public struct Emu
    {
        ...
        {
            throw new OpenXmlPowerToolzException("Can't convert directly to string, must cast to long");
        }
    }
    ...
    public struct TPoint
    {
        ...
        public override string ToString()
        {
            throw new OpenXmlPowerToolzException("Can't convert directly to string, must cast to double");
        }
    }
