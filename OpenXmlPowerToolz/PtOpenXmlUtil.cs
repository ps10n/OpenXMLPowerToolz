...
namespace OpenXmlPowerToolz
{
    ...
    public static class WordprocessingMLUtil
    {
        ...
        public static int CalcWidthOfRunInTwips(XElement r)
        {
            ...
            if (fontName == null)
                throw new OpenXmlPowerToolzException("Internal Error, should have FontName attribute");
            if (UnknownFonts.Contains(fontName))
                return 0;

            var rPr = r.Element(W.rPr);
            if (rPr == null)
                throw new OpenXmlPowerToolzException("Internal Error, should have run properties");
...
listSeparator
    ...
    public class OpenXmlPowerToolzException : Exception
    {
        public OpenXmlPowerToolzException(string message) : base(message) { }
    }
