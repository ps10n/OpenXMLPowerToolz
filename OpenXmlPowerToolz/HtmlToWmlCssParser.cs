...
namespace OpenXmlPowerToolz.HtmlToWml.CSS
{
    ...
    public class CssSimpleSelector
    {
        ...
        public override string ToString()
        {
            ...
            if (m_combinator.HasValue)
            {
                ...
                {
                    case OpenXmlPowerToolz.HtmlToWml.CSS.CssCombinator.PrecededImmediatelyBy:
                        sb.Append(" + ");
                        break;
                    case OpenXmlPowerToolz.HtmlToWml.CSS.CssCombinator.ChildOf:
                        sb.Append(" > ");
                        break;
                    case OpenXmlPowerToolz.HtmlToWml.CSS.CssCombinator.PrecededBy:
                        sb.Append(" ~ ");
                        break;
                }
            }
    ...
    public class CssTerm
    {
        ...
        public override string ToString()
        {
            ...
            else
            {
                ...
                if (m_unit.HasValue)
                {
                    if (m_unit.Value == OpenXmlPowerToolz.HtmlToWml.CSS.CssUnit.Percent)
                    {
                        sb.Append("%");
                    }
                    else
        ...
        private int GetRGBValue(CssTerm t)
        {
            try
            {
                if (t.Unit.HasValue && t.Unit.Value == OpenXmlPowerToolz.HtmlToWml.CSS.CssUnit.Percent)
                {
    ...
    public class CssParser
    {
        ...
        public CssDocument ParseText(string content)
        {
            ...
            catch (OpenXmlPowerToolzException e)
            {
                string msg = e.Message + ".  CSS => " + content;
                throw new OpenXmlPowerToolzException(msg);
            }
        }

        // following method should be private, as it does not properly re-throw OpenXmlPowerToolzException
    ...
    public class Parser
    {
        ...
        void SimpleSelector(out CssSimpleSelector ss)
        {
            ...
            ss.ElementName = "";
            string psd = null;
            OpenXmlPowerToolz.HtmlToWml.CSS.CssAttribute atb = null;
        ...
        void Attrib(out OpenXmlPowerToolz.HtmlToWml.CSS.CssAttribute atb)
        {
            atb = new OpenXmlPowerToolz.HtmlToWml.CSS.CssAttribute();
            atb.Value = "";
            string quote = null;
            string ident = null;
    ...
    public class Errors
    {
        ...
        public virtual void SyntaxError(int line, int col, int n)
        {
            ...
            throw new OpenXmlPowerToolzException(errorString);
        }
        ...
        {
            throw new OpenXmlPowerToolzException(s);
        }
